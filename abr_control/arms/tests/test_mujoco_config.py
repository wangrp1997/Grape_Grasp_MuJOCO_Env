...
#
#     # check inertias
#     asset np.allclose(muj_I[link1], test_I[1], atol=1e-5)
#     asset np.allclose(muj_I[link2], test_I[2], atol=1e-5)
#     # check masses
#     asset np.allclose(muj_m[link1], test_m[1], atol=1e-5)
#     asset np.allclose(muj_m[link2], test_m[2], atol=1e-5)
#
#     q_vals = np.linspace(0, 2 * np.pi, 50)
#     for q0 in q_vals:
#         for q1 in q_vals:
...
#
#             asset np.allclose(muj_J1, test_J1)
#             asset np.allclose(muj_J2, test_J2)
#
...
#
#             asset np.allclose(muj_M, test_Mx)
